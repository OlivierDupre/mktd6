...
public class ServerStores {
    ...
    public static final StateStoreHelper<Trader, TraderState> STATE_STORE = new StateStoreHelper(
            "trader-state-store",
    ...
    public static final StateStoreHelper<Trader, Double> TRADER_INVESTMENT = new StateStoreHelper(
