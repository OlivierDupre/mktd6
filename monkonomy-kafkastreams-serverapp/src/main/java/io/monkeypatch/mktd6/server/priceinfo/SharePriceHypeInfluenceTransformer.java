...
import io.monkeypatch.mktd6.server.model.BurstStep;
...
import static io.monkeypatch.mktd6.server.model.ServerStoreConstants.BURSTS_KEY;
...
public class SharePriceHypeInfluenceTransformer implements ValueTransformer<Double, Double> {
    ...
    public Double transform(Double value) {
        priceStore.putIfAbsent(BURSTS_KEY, 0d);

        double bursts = priceStore.get(BURSTS_KEY);
        ...
        if (step != null) {
            ...
            priceStore.put(BURSTS_KEY, bursts);
